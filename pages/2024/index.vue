  ...
  <div>
    <div class="flex w-full justify-between">
      <div class="relative pt-20">
        ...
        <h1 class="font-medium text-4xl slide-enter-content">Hey, I am Qingyun125 (qìng yǔn).</h1>
  ...
  flagList: [
    {
      ...
      percentage: () => ((25/366)*100).toFixed(2)
    },
    {
...
a:after {
  ...
  right: -0.1em;
  bottom: 0;
  transition: top 200ms cubic-bezier(0, 0.8, 0.25, 1);
